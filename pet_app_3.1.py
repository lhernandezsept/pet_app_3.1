...
image_path = os.path.join(os.getcwd(), "assets", "boston.jpg")
set_background(image_path)  # ✅ Full safe path
...
def feeding_page():
    show_clock()
    st.image("/Users/Lisbeth/Desktop/Programming/pet_app_2/Records/App python/smile.jpg", use_column_width=True)
...
def wellness_page():
    show_clock()
    st.image("/Users/Lisbeth/Desktop/Programming/pet_app_2/Records/App python/meme.jpg", use_column_width=True)
...
def enrichment_page():
    ...
    col1, col2 = st.columns(2)
    with col1:
        st.image("/Users/Lisbeth/Desktop/Programming/pet_app_2/Records/App python/friends.jpg", use_column_width=True)
    with col2:
        st.image("/Users/Lisbeth/Desktop/Programming/pet_app_2/Records/App python/rope.jpg", use_column_width=True)
...
def past_records_page():
    show_clock()
    st.image("/Users/Lisbeth/Desktop/Programming/pet_app_2/Records/App python/relax.jpg", use_column_width=True)
